...
class _SetupBluetoothDevicesSheetState
    extends State<_SetupBluetoothDevicesSheet> {
  ...
  Future<void> _onPick(BleScanResult device) async {
    ...
    try {
      ...
      unawaited(
        AppFlushbar.error('Could not connect: $e', title: 'Connection failed'),
      );
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: Theme.of(
                context,
              ).textTheme.compactAppBarTitle(const Color(0xFF1D2329)),
            ),
            ...
            Text(
              ...
              style: Theme.of(
                context,
              ).textTheme.compactSupportingText(const Color(0xFF70757A)),
            ),
